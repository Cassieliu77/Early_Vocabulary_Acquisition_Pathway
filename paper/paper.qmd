...
The original dataset was obtained from @cdi and downloaded using the R package from @wordbankr. After a thorough cleaning process such as grouping related items and removing missing values, the analysis focuses on key variables, including category, age, comprehension, production and is_norming. These variables form the foundation of the analysis dataset, with an overview provided in @tbl-data.

```{r}
#| label: tbl-data
#| tbl-cap: Cleaned Wordbank Dataset
#| echo: false
