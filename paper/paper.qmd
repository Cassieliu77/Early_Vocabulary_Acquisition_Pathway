...
Age emerges as the strongest predictor of vocabulary acquisition, with sharp increases in predicted probabilities reflecting the rapid language development typically observed between 18 and 30 months. This period is crucial for linguistic growth, as children steadily expand both production and comprehension skills. The upward trend in median vocabulary scores illustrates consistent progress during this developmental window. However, the widening variability across percentiles highlights diverse learning trajectories. Some children exhibit accelerated vocabulary growth, while others progress more gradually, influenced by factors such as environmental exposure, socio-economic background, and cognitive differences.
...
The analysis of lexical categories reveals distinct acquisition patterns. Frequently encountered categories like “Function Words,” “Living Things,” and “Objects” demonstrate higher predicted probabilities, forming the foundation of early communication. In contrast, categories such as “Verbs” and “Sensory Words” show lower predicted probabilities and greater variability, reflecting the cognitive and contextual demands associated with learning these words. Their acquisition often depends on abstract reasoning or specific contexts, which develop later in the language-learning process.

The variability within categories highlights the interplay between shared language exposure and individual experiences. Categories with higher probabilities suggest a universal baseline of language learning, whereas broader variability in categories like “Adjectives” and “Sensory Words” may result from cultural or environmental factors. Additionally, as children transition from foundational to more advanced vocabulary, the limitations of the CDI instrument become apparent. The plateau observed in vocabulary growth beyond 24 months likely reflects the restricted scope of words included in the inventory, rather than a genuine slowing of linguistic development.

## Broader Implications for Language Development

The findings of this study provide valuable insights for early education and language intervention programs by identifying word categories that are more challenging for children to acquire. For example, verbs and sensory words, which demand greater contextual understanding, could be prioritized in storytelling, play, and educational activities to support their development. Tailored language development strategies can address individual needs: children with slower foundational vocabulary growth may benefit from increased exposure to high-frequency words, while those excelling in comprehension could advance through activities introducing more complex or context-specific terms, enriching their linguistic repertoire.

Key predictors, including age, norming status, and lexical categories, significantly influenced vocabulary acquisition. Age emerged as the strongest determinant, with older children exhibiting higher vocabulary scores, aligning with developmental milestones. Children in the norming group displayed enhanced vocabulary acquisition, likely due to their structured linguistic environments. Lexical categories revealed intriguing patterns: objects and verbs had higher predicted probabilities, emphasizing their functional importance in early communication. In contrast, sensory words and adjectives showed less consistent acquisition, reflecting the later emergence of more sophisticated linguistic skills.
...
Additionally, the dataset we have now is limited on the word categories. Future research should also explore the influence of environmental and contextual factors, such as language exposure, educational interventions, and socio-economic status, on vocabulary acquisition. These factors could provide a more comprehensive understanding of the mechanisms underlying linguistic development.
