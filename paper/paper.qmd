...
@song also point out in their study on 264 typically developing Chinese children (145 boys and 119 girls) were included from a longitudinal study of language. While the findings offer valuable directions, several limitations should be acknowledged. 

This study sheds light on key aspects of vocabulary acquisition, but certain limitations must be acknowledged. First, the reliance on parental reports, as collected through the MacArthur-Bates Communicative Development Inventories (CDI), introduces potential biases. Parents may overestimate or underestimate their child’s abilities due to memory limitations, subjective interpretation, or social desirability. Such biases could affect the accuracy of the data, particularly for categories requiring nuanced understanding, like Sensory Words. To mitigate these limitations, future research should incorporate complementary methods, such as direct observational studies or experimental assessments, to provide more reliable and objective measurements of children’s vocabulary development.

The cross-sectional nature of the dataset also limits the ability to capture individual developmental trajectories over time. While cross-sectional data offers a snapshot of vocabulary acquisition, it cannot account for within-child variability or the dynamic progression of language learning. Longitudinal studies are essential for understanding how vocabulary grows and evolves across different ages and contexts. By tracking the same children over extended periods, researchers could uncover mechanisms driving individual differences in learning rates, identify critical intervention windows, and observe the long-term effects of early linguistic exposure.

Another limitation lies in the dataset’s word category representation. While foundational categories like Function Words and Objects are well-represented, others, such as Sensory Words and Adjectives, are underrepresented, limiting the analysis of these more complex and context-dependent types. Future datasets should strive for a more balanced representation of word categories to explore their unique developmental trajectories. Additionally, integrating contextual factors such as socio-economic status, bilingualism, and parental language practices into future studies could provide a deeper understanding of how these variables influence vocabulary growth. These enhancements would allow for more comprehensive models that account for environmental diversity and linguistic richness.
